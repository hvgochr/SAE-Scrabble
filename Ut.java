...
public class Ut {
	...
	/**
	 * Méthode estUneMajuscule
	 * Action: vérifie selon la norme de codage américaine ASCII si le caractère
	 * passé en paramètre est une majuscule.
	 * 
	 * @param c
	 * @return
	 */
	...
	/**
	 * Méthode majToIndex
	 * Action: convertit le caractère passé en paramètre en un entier entre 0 et 26
	 * selon la norme de codage américaine ASCII.
	 * 
	 * @param c
	 * @return
	 */
	...
	/**
	 * Méthode indexToMaj
	 * Action: convertit l'entier passé en paramètre en un caractère selon la norme
	 * de codage américaine ASCII.
	 * 
	 * @param c
	 * @return
	 */
